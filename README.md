...
```bash
bash <(curl -L -s [https://raw.githubusercontent.com/Tangfffyx/Public/main/Script/sing-box.sh](https://raw.githubusercontent.com/Tangfffyx/Public/main/Script/sing-box.sh))
